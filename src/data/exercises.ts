...
export const exercisesData: ExerciseKnowledge[] = [
  ...
  // ============================================
  {
    ...
    musculosSecundarios: [GrupoMuscular.TRICEPS, GrupoMuscular.HOMBROS],
    categoria: 'compuesto',
    tier: 'S',
  ...
  // PECHO - Tier A
  {
    ...
    grupoMuscular: GrupoMuscular.PECHO,
    musculosSecundarios: [GrupoMuscular.HOMBROS, GrupoMuscular.TRICEPS],
    categoria: 'compuesto',
    tier: 'A',
    dificultad: 'intermedio',
    equipamiento: ['barra'],
  ...
  // ============================================
  {
    ...
    musculosSecundarios: [GrupoMuscular.BICEPS, GrupoMuscular.ANTEBRAZOS],
    categoria: 'compuesto',
    tier: 'S',
    dificultad: 'intermedio',
    equipamiento: ['peso_corporal'],
  ...
  },
  {
    ...
    grupoMuscular: GrupoMuscular.ESPALDA,
    musculosSecundarios: [GrupoMuscular.BICEPS, GrupoMuscular.FEMORALES_GLUTEOS],
    categoria: 'compuesto',
    tier: 'S',
    dificultad: 'avanzado',
    equipamiento: ['barra'],
  ...
  // ============================================
  {
    ...
    musculosSecundarios: [GrupoMuscular.FEMORALES_GLUTEOS, GrupoMuscular.ABDOMINALES],
    categoria: 'compuesto',
    tier: 'S',
    dificultad: 'intermedio',
    equipamiento: ['barra'],
  ...
  // FEMORALES Y GLÚTEOS - Tier S
  {
    ...
    musculosSecundarios: [GrupoMuscular.ESPALDA, GrupoMuscular.PIERNAS, GrupoMuscular.ABDOMINALES],
    categoria: 'compuesto',
    tier: 'S',
    dificultad: 'avanzado',
    equipamiento: ['barra'],
  ...
  },
  {
    ...
    nombre: 'Hip Thrust',
    grupoMuscular: GrupoMuscular.FEMORALES_GLUTEOS,
    musculosSecundarios: [GrupoMuscular.PIERNAS, GrupoMuscular.ABDOMINALES],
    categoria: 'compuesto',
    tier: 'A',
    dificultad: 'intermedio',
  ...
  // ============================================
  {
    ...
    musculosSecundarios: [GrupoMuscular.TRICEPS, GrupoMuscular.PECHO],
    categoria: 'compuesto',
    tier: 'S',
    dificultad: 'intermedio',
    equipamiento: ['barra'],
  ...
  },
  {
    ...
    enfoqueMuscular: ['deltoides lateral'],
    tecnica: {
      posicionInicial: 'Sentado en la máquina de elevaciones laterales, codos sobre los pads, pies firmes en el suelo.',
      ejecucion: [
        'Elevar los brazos hacia los lados hasta la altura del hombro',
        'Tensión constante durante todo el recorrido',
        'Bajar controladamente sin dejar caer el peso',
      ],
      erroresComunes: ['Subir por encima de hombros', 'Usar impulso del torso'],
      consejosClave: ['Tensión constante superior a mancuernas', 'Control estricto — sin balanceo'],
    },
    imagenes: { posicionInicial: '', ejecucion: [], errores: [] },
    variantes: [],
    descansoSugerido: 45,
    tags: ['aislamiento_hombro', 'deltoides_lateral'],
  },
  {
    id: 'elevaciones-laterales-sentado',
    nombre: 'Elevaciones Laterales Sentado (FST-7)',
    grupoMuscular: GrupoMuscular.HOMBROS,
    categoria: 'aislamiento',
    tier: 'A',
    dificultad: 'principiante',
    ...
    enfoqueMuscular: ['deltoides lateral'],
    tecnica: {
      posicionInicial: 'Sentado en un banco, mancuernas a los lados. Espalda recta.',
      ejecucion: [
        '7 series × 8-10 reps con descansos de 30-45 s (FST-7)',
        'Elevar hacia los lados hasta altura de hombros',
        'Bajar controlado — máximo bombeo y estiramiento de fascia',
      ],
      erroresComunes: ['Descansos demasiado largos entre series FST-7', 'Peso excesivo'],
      consejosClave: ['FST-7: el objetivo es el bombeo máximo, no el peso', 'Fascia Stretch Training para mayor amplitud de hombros'],
    },
    imagenes: { posicionInicial: '', ejecucion: [], errores: [] },
    variantes: [],
    descansoSugerido: 45,
    tags: ['aislamiento_hombro', 'deltoides_lateral', 'fst7'],
  },
  {
