                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex justify-between items-center pt-2 border-t">
                            ...
                            <span className={`font-bold flex items-center gap-1 ${analysis.volumenTotal.cambio > 0 ? 'text-green-500' : 'text-red-500'
                              }`}>
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex justify-between items-center pt-2 border-t">
                            ...
                            <span className={`font-bold ${analysis.pesoMaximo.cambio > 0 ? 'text-green-500' : 'text-gray-500'
                              }`}>
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          {[1, 2, 3, 4, 5].map(i => (
                            <div
                              key={i}
                              className={`h-2 w-2 rounded-full ${i <= workout.sensacionGeneral ? 'bg-primary' : 'bg-muted'
                                }`}
                            />
                          ))}
